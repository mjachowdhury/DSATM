...
public class MyDynamicList {
	...
	/**
	 * The constructor creates 1 instance (1 object) of the class
	 * MyDynamicList<br>
	 */
	...
	// -------------------------------------------------------------------
	// Basic Operation --> Get number of integers in MyDynamicList:
	// my_get_length
	// -------------------------------------------------------------------
	/**
	...
	// -------------------------------------------------------------------
	// Basic Operation --> Get integer of MyDynamicList at a concrete index:
	// my_get_element
	// -------------------------------------------------------------------
	/**
	 * Given a concrete MyDynamicList and a concrete index, it returns the item
	 * placed at that index (if any).<br>
	...
	public int getElement(int index) {
		...
		// Rule 1. Valid index
		case 1:
			// 1. We declare a reference node and a count of the elements we
	...
	// -------------------------------------------------------------------
	// Basic Operation --> Add integer to MyDynamicList at a concrete index:
	// my_add_element
	// -------------------------------------------------------------------
	/**
	 * Given a concrete MyDynamicList, an index and an item, it adds the item at
	 * the desired index of MyDynamicList (if capacity allows it).<br>
	...
	public void addElement(int index, int item) {
		...
		// Rule 2. Valid index, add after head
		case 2:
			// 1. We declare a reference node to head, and another one pointing
	...
	// -------------------------------------------------------------------
	/**
	 * Given a concrete MyDynamicList and index, it removes the item placed at
	 * the desired index of MyDynamicList (if any).
